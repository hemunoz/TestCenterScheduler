...
public class StudentUI {
                ...
                lookup.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        String query = "Select a.checkedin, a.date, a.starttime, a.endtime, e.examname from has h, forexam f,"
                                ...
                                + " AND e.term = '" + term + "' AND a.appointmentID = h.appointmentID "
                                + "AND h.studentID = '" + s.getID() + "' AND a.checkedin != 'superfluous'";
    ...
    public void switchToAppointmentConfirmationPage(Student s, Exam exam, Date date, Time time, String term) {
        ...
        app.addappointment(exam.getExamID(), s.getID() + "", date, time, term);
        ...
        btnSubmit.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                 ...
                 */ else if (exam.availableseats(exam.getExamID() + "", term, dates.get(datecomboBox.getSelectedIndex()), times.get(timecomboBox.getSelectedIndex())) == false) {
                    ...
                    switchToAppointmentConfirmationPage(s, exam, dates.get(datecomboBox.getSelectedIndex()), times.get(timecomboBox.getSelectedIndex()), term);
                }
